...
{
    [ActionUuid(Uuid = "com.refractored.mystreamtimer.action.countdown")]
    public class CountdownAction : BaseStreamDeckActionWithSettingsModel<Models.CountdownSettingsModel>
    {
        public override async Task OnKeyUp(StreamDeckEventPayload args)
        {
            try
            {
                ...
                var url = @$"mystreamtimer://countdown/?mins={SettingsModel.Minutes}";
